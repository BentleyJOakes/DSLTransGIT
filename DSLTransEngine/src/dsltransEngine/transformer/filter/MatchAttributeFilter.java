...
public class MatchAttributeFilter extends AbstractFilter {
	...
	private final dsltrans.MatchAttribute _attribute;
	private MetaModelDatabase _metaModel;
	private InstanceAttribute _currentAttribute;
	private MatchEntityFilter _entity;
	
	public MatchAttributeFilter(dsltrans.MatchAttribute ma, String id, MatchEntityFilter mef, InstanceDatabaseManager instanceDatabaseManager) {
	...
	public dsltrans.MatchAttribute getAttribute() {
		return _attribute;
	}
