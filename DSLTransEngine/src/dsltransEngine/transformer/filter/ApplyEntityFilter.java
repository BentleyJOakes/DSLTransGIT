...
public class ApplyEntityFilter extends AbstractFilter {
	...
	private final dsltrans.ApplyClass _class;
	...
	public ApplyEntityFilter(TransformationRule tr,dsltrans.ApplyClass mc, String id, InstanceDatabaseManager instanceDatabaseManager) {
		...
		for(Object obj : getApplyClass().getAttribute()) {
			ApplyAttribute ma = (ApplyAttribute) obj;
			getFilterAttributes().add(new ApplyAttributeFilter(ma,id,this, getTransformationRule().getRule(), instanceDatabaseManager));
		}
	}	

	public dsltrans.ApplyClass getApplyClass() {
		return _class;
	}
